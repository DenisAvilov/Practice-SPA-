...
spa.chat = (function () {
    var
        configMap = {
           ...
           +'</div>',
            ...
            settable_map : {
                ...
                slider_closed_em   : 2,
                slider_opened_title: "Щелкните, чтобы свернуть",
                slider_closed_title: "Щелкните, чтобы раскрыть",
        ...
        setJqueryMap, configModule, initModule, getEmSize,
        setPxSizes, // для задания размеров окна чата в пикселях
        setSliderPosition, // открытый метод
        onClickToggle, //изменяет якорь в URI и быстро возвращает управление
...
// 4.5. Добавление часто используемых методов продолжить с 182 стр
